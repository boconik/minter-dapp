...
const PREREVEAL_TOKEN_URI = "ipfs://bafkreieetfcsgmhjuxcvet4k5lcexpz7ctokabmsoobazsb3uaayawbih4"; // only update if you want to manually set the prereveal token uri
